...
KING_SCORE_COMPONENTS = {
    ...
    "Entry Timing":          (10, 10, "Pullback + ORB + FPE9 + VWAP band + sector filter + gap + TOD window. Complete."),
    "Exit Strategy":         (9,  10, "ATR T1/T2/T3 + trailing + vol compression + premium lock. Missing: live exit tuning."),
    ...
    "Backtesting Rigor":     (10, 10, "3-scenario MC + per-signal attribution + walk-forward validator + regime stratification. Complete."),
